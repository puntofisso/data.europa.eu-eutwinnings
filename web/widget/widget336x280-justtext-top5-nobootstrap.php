...
<body>
  ...
  <hr/>
    <div><span  class="badge bg-success">#1</span><span id="top1"></span></div>
    <div><span  class="badge bg-success">#2</span><span id="top2"></span></div>
    <div><span  class="badge bg-success">#3</span><span id="top3"></span></div>
    <div><span  class="badge bg-success">#4</span><span id="top4"></span></div>
    <div><span  class="badge bg-success">#5</span><span id="top5"></span></div>
...
<script>
    ...
    $(document).ready( function() {
      $.getJSON("widget-getdata.php?code=<?php echo $nutsid;?>", function(data){
          ...
          $('#top1').html("<a href='https://data-europa-eu.eu-twinnings.site/region.php?nutsid=" + data.similarity_same_country_top[0].code + "'>" +(data.similarity_same_country_top[0]).name + "</a>");
          $('#top2').html("<a href='https://data-europa-eu.eu-twinnings.site/region.php?nutsid=" + data.similarity_same_country_top[1].code + "'>" +(data.similarity_same_country_top[1]).name + "</a>");
          $('#top3').html("<a href='https://data-europa-eu.eu-twinnings.site/region.php?nutsid=" + data.similarity_same_country_top[2].code + "'>" +(data.similarity_same_country_top[2]).name + "</a>");
          $('#top4').html("<a href='https://data-europa-eu.eu-twinnings.site/region.php?nutsid=" + data.similarity_same_country_top[3].code + "'>" +(data.similarity_same_country_top[3]).name + "</a>");
          $('#top5').html("<a href='https://data-europa-eu.eu-twinnings.site/region.php?nutsid=" + data.similarity_same_country_top[4].code + "'>" +(data.similarity_same_country_top[4]).name + "</a>");
